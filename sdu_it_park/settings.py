"""
Django settings for sdu_it_park project.
...
SECRET_KEY = 'django-insecure-u)p_^cry56qw%trn155vno#9l0&o%qps59!3%-orhxrg8!tcjs'
...
WSGI_APPLICATION = 'sdu_it_park.wsgi.application'
